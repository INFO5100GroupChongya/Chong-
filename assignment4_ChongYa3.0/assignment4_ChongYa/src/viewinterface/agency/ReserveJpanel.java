...
//        System.out.println("");
        ...
        for (int i=0;i<overlap.getO_id().size();i++){
            for (int j=0; j<overlap.getO_id().size();j++){
               if(i==j) continue;
               if(overlap.getO_id().get(i).equals(overlap.getO_id().get(j))){
                   if( (overlap.getO_departure().get(i).compareTo(overlap.getO_arrival().get(j))<0)  && (overlap.getO_departure().get(j).compareTo(overlap.getO_arrival().get(i))<0) ){
                        ...
                        System.out.println(overlap.getO_id());
                        overlap.rmToN(c.getUserID());
