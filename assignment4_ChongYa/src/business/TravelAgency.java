...
public class TravelAgency {
    ...
    public TravelAgency(){
        ...
        try {
            Flight flight1 = new Flight("Boston", "Beijing", dateFormat.parse("2020-10-12 12:00:00"), dateFormat.parse("2020-10-17 18:00:00"));
            Flight flight2 = new Flight("Shanghai", "Beijing", dateFormat.parse("2020-10-13 16:45:00"), dateFormat.parse("2020-10-16 19:00:00"));
            Flight flight3 = new Flight("Guangzhou", "London", dateFormat.parse("2020-10-16 12:00:00"), dateFormat.parse("2020-10-19 18:00:00"));
            Flight flight4 = new Flight("Osaka", "Beijing", dateFormat.parse("2020-10-17 16:10:00"), dateFormat.parse("2020-10-17 21:05:00"));
            Flight flight5 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight6 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight7 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight8 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight9 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight10 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight11 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
            Flight flight12 = new Flight("Newyork", "Canberra", dateFormat.parse("2020-10-18 12:00:00"), dateFormat.parse("2020-10-22 23:00:00"));
        ...
        Customer customer4 = new Customer("440981199408050540", "David Wang");
